...
document.addEventListener('DOMContentLoaded',() => {
    ...
    document.querySelector('.basicAutoComplete').addEventListener('click', (e) => {
        e.stopPropagation();
    ...
    document.querySelector('.basicAutoComplete').addEventListener('keypress', (e) => {
        if(typing == false) {
            typing = true;
        } else {
...
function getDataMovie(idMovie)
{
    Promise.all([
        ...
        // récupération de l'affiche
            ...
            document.querySelector("#affiche").value = `https://image.tmdb.org/t/p/w400${data[0].poster_path}`;
